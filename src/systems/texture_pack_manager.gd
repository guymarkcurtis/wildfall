...
const PACK_ASSETS: PackedStringArray = [
	...
	"assets/items/pickups/awning.png",
	"assets/items/pickups/bed.png",
	"assets/items/pickups/bookcase.png",
	"assets/items/pickups/brazier.png",
	"assets/items/pickups/bread.png",
	"assets/items/pickups/bronze_ingot.png",
	"assets/items/pickups/cabinet.png",
	"assets/items/pickups/campfire.png",
	"assets/items/pickups/chair.png",
	"assets/items/pickups/charcoal.png",
	"assets/items/pickups/chest.png",
	"assets/items/pickups/corner_post.png",
	...
	"assets/items/pickups/fence_gate.png",
	...
	"assets/items/pickups/hearth.png",
	...
	"assets/items/pickups/metal_fence.png",
	"assets/items/pickups/metal_gate.png",
	"assets/items/pickups/metal_grate.png",
	"assets/items/pickups/metal_lantern.png",
	"assets/items/pickups/metal_locker.png",
	"assets/items/pickups/metal_railing.png",
	"assets/items/pickups/metal_roof.png",
	"assets/items/pickups/metal_stair.png",
	"assets/items/pickups/plank.png",
	"assets/items/pickups/planter_box.png",
	"assets/items/pickups/potion_health.png",
	"assets/items/pickups/potion_mana.png",
	"assets/items/pickups/reinforced_floor.png",
	"assets/items/pickups/reinforced_wall.png",
	"assets/items/pickups/rug.png",
	"assets/items/pickups/seed_wheat.png",
	"assets/items/pickups/shelf.png",
	"assets/items/pickups/shuttered_window.png",
	"assets/items/pickups/signal_pole.png",
	"assets/items/pickups/soup.png",
	"assets/items/pickups/steps.png",
	...
	"assets/items/pickups/stone_gate.png",
	"assets/items/pickups/stone_hammer.png",
	"assets/items/pickups/stone_hoe.png",
	"assets/items/pickups/stone_path.png",
	"assets/items/pickups/stone_patio.png",
	"assets/items/pickups/stone_pickaxe.png",
	"assets/items/pickups/stone_pillar.png",
	"assets/items/pickups/stone_planter.png",
	"assets/items/pickups/stone_railing.png",
	...
	"assets/items/pickups/wardrobe.png",
	"assets/items/pickups/well.png",
	"assets/items/pickups/wooden_axe.png",
	"assets/items/pickups/wooden_bow.png",
	"assets/items/pickups/wooden_deck.png",
	...
	"assets/items/pickups/wooden_path.png",
	"assets/items/pickups/wooden_pickaxe.png",
	"assets/items/pickups/wooden_pillar.png",
	"assets/items/pickups/wooden_porch.png",
	"assets/items/pickups/wooden_railing.png",
...
static func _asset_metadata() -> Array[Dictionary]:
	...
	assets.append_array([
		...
		},
		{
			...
			"layout": {"kind": "atlas", "columns": 9, "rows": 2, "cell_size": 32,
					"cell_order": "row 0: wood wall, wood door, wood window, stone wall, stone door, stone window, metal wall, metal door, metal window; row 1: wood railing, wood fence, wood gate, stone railing, stone gate, (empty), metal railing, metal fence, metal gate"},
			"editor_note": "Elevation art (the front of the part seen from the yard), not top-down. Keep every cell at 32 x 32 and preserve the 9-column order; row 1 column 5 stays empty (no stone fence) and row 0 column 7 (metal door) is authored ahead of a future metal door part."
		},
		{
