...
func _load_technologies() -> void:
	...
	_define("wood_building", "Wood Construction",
		...
		[], [], true,
		["wooden_foundation", "wooden_floor", "wooden_wall", "wooden_window", "wooden_door", "wooden_roof", "wooden_stairs", "wooden_stairs_down", "wooden_ramp", "wooden_pillar", "fence", "fence_gate", "wooden_railing", "wooden_porch", "wooden_deck", "wooden_path", "planter_box", "wooden_table", "yard_lantern", "chair", "shelf", "rug", "wardrobe", "steps", "awning", "corner_post"])
	_define("stone_building", "Stone Construction",
		...
		["stone_brick", "stone_foundation", "stone_floor", "stone_wall", "stone_window", "stone_door", "stone_roof", "stone_stairs", "stone_stairs_down", "stone_ramp", "stone_pillar", "stone_gate", "stone_railing", "stone_patio", "stone_path", "stone_planter", "hearth", "cabinet", "bookcase", "well", "brazier"])
	_define("metalworking", "Metalworking",
		...
		["iron_ingot", "copper_ingot", "bronze_ingot", "iron_axe", "iron_pickaxe", "iron_sword", "anvil", "reinforced_floor", "reinforced_wall", "metal_roof", "metal_gate", "metal_railing", "metal_grate", "shuttered_window", "metal_stair", "metal_stair_down", "metal_fence", "signal_pole", "metal_lantern", "workshop_cabinet", "metal_locker"])
