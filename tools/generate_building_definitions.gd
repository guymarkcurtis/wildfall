...
func _write_profiles() -> void:
	...
	_save_profile("station_campfire.tres", _profile(StationProfile, {"recipe_group": "campfire", "input_slot_count": 3, "output_slot_count": 1, "requires_power": true}))
	_save_profile("station_furnace.tres", _profile(StationProfile, {"recipe_group": "furnace", "input_slot_count": 3, "output_slot_count": 1, "requires_power": true}))
